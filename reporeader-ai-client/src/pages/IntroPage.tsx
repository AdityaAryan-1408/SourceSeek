                ...
                <section className="w-full pb-32 px-4">
                    ...
                    <div className="space-y-32">
                        <FeatureSection
                            ...
                            description="Just paste a link to any public GitHub repository. RepoReader will clone, parse, and index the entire codebase, building a smart graph of its structure."
